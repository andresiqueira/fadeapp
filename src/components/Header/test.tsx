...
describe('<Header />', () => {
  ...
  it('should render desktop menu', async () => {
    ...
    const testimonialMobileLink = queryByRole('menuitem', { name: 'Depoimentos' })
  ...
  it('should render mobile menu', async () => {
    ...
    const listLinksDesktop = getByRole('list', {hidden: true})
    expect(listLinksDesktop.getAttribute('aria-hidden')).toBe('true')
  })
  ...
  it('should handle the open/close mobile menu', async () => {
    ...
    const showTestimonialMobileLink = getByRole('menuitem', { name: 'Depoimentos' })
  ...
  it('should change menu styles on scroll', async () => {
   ...
   it('should match snapshot', () => {
    const { container } = render(<Header routes={routes} />)
